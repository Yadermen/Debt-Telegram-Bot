...
LANGS = {
    'ru': {
        ...
        "debt_reminders_status_on": "Автоматические напоминание долгов\nВ {time} {status}",
        "debt_reminders_status_off": "Напоминания о долгах отключены {status}",
        ...
        "statistics_title": "Qarz Nazorat — ваша статистика",
        "statistics_debts": "💸 Долги",
        "statistics_loans": "💵 В долг дали",
        "statistics_difference": "⚖️ Разница",
        "statistics_month": "📅 За {month}",
        "statistics_closed": "✅ Закрыто долгов",
        "statistics_remaining": "❌ Осталось",
        "statistics_currency": "🌍 Валюта",
        "statistics_btn_currency": "🌍 Валюта",
        "statistics_btn_export": "📊 Экспорт в Excel",
        "statistics_btn_back": "⬅️ Меню",
    },
    'uz': {
        ...
        "statistics_title": "Qarz Nazorat — sizning statistikangiz",
        "statistics_debts": "💸 Qarzlar",
        "statistics_loans": "💵 Qarzga berdim",
        "statistics_difference": "⚖️ Farq",
        "statistics_month": "📅 {month} oyi uchun",
        "statistics_closed": "✅ Yopilgan qarzlar",
        "statistics_remaining": "❌ Qolgan",
        "statistics_currency": "🌍 Valyuta",
        "statistics_btn_currency": "🌍 Valyuta",
        "statistics_btn_export": "📊 Excelga eksport",
        "statistics_btn_back": "⬅️ Menyu",
        "lang_uz": "O'zbek tili",
        ...
        # Подменю «Напоминания о долгах»
        "debt_reminders_status_on": "Avtomatik qarz eslatmasi\nSoat {time}da {status}",
        "debt_reminders_status_off": "Qarz eslatmalari o'chirilgan {status}",
